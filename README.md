...
- `/revenue-ranking` — จัดอันดับรายได้สะสมของ 11 พื้นที่ภายใน 3 กลุ่ม Ranking เฉพาะพื้นที่ อป.
...
รายงาน Broadband, Datacom, Fixed Line, Mobile Retail, ICT-Solution, Digital, พัฒนาสินทรัพย์ และ e-Office ใช้โครงสร้างเดียวกับรายงานรายได้ Broadband โดยจำกัดรายได้และเป้าหมายไว้ที่ `อป. — ภาคตะวันออก` ผ่าน Mapping `organization_group_units` เท่านั้น แต่ละหน้ามี KPI กราฟแนวตั้ง 4 ส่วน ตารางเต็มหน้าจอ 16:9 และ Excel export แยกสีตามรายงาน รายงาน e-Office แสดงจำนวนเงินทั้งหมดเป็นหน่วยบาททั้งบน KPI กราฟ ตาราง และ Excel เนื่องจากมีมูลค่าต่ำกว่าบริการอื่น ส่วนรายงานที่เหลือยังแสดงหน่วยล้านบาท โดยฐานข้อมูลยังคงเก็บจำนวนเงินจริงเป็นบาททุกหน้า
...
## รายงาน Ranking พื้นที่ อป.

หน้า `/revenue-ranking` ใช้ข้อมูลจาก RPC รายพื้นที่เดียวกับ `/op-area-overview` เพื่อให้ยอดรายได้สะสมและช่วงเปรียบเทียบตรงกัน โดยแบ่ง 11 พื้นที่เป็น 3 กลุ่มตามข้อกำหนดธุรกิจ:

- Super Demander (L): ระยอง, แหลมฉบัง, ชลบุรี, จันทบุรี
- Star Champion (M): มาบตาพุด, ฉะเชิงเทรา, พัทยา, ปราจีนบุรี
- Rising Star (S): สระแก้ว, ตราด, นครนายก

อันดับคำนวณใหม่จากรายได้สะสมปีปัจจุบันจากมากไปน้อยภายในกลุ่มเดียวกัน หากปีก่อนมีข้อมูลครบช่วง ตารางจะแสดงรายได้ช่วงเดียวกัน ส่วนต่าง และเปอร์เซ็นต์เปลี่ยนแปลงด้วย ตารางใช้ธีมเหลืองเข้ม–เทาบนพื้นสว่าง มีเส้นแบ่งกลุ่ม โหมดเต็มหน้าจอ 16:9 และ Excel export ที่คงกลุ่ม เซลล์ตัวเลข และอันดับเดียวกับหน้าจอ
