...
import { OpServiceOverviewReport } from "@/components/reports/op-service-overview-report";
import { resolveReportingPeriod, type AvailableYear } from "@/lib/revenue/reporting-period";
import { createClient } from "@/lib/supabase/server";

export default async function OpServiceOverviewPage({
  searchParams,
}: {
  ...
  return <OpServiceOverviewReport availableYears={availableYears} initialYear={period.year} />;
}
