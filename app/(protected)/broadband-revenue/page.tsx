...
import { BroadbandRevenueReport } from "@/components/reports/broadband-revenue-report";
...
export default async function BroadbandRevenuePage({
  ...
  return <BroadbandRevenueReport availableYears={availableYears} initialYear={period.year} />;
}
