...
import { OrganizationOverviewReport } from "@/components/reports/organization-overview-report";
...
export default async function OrganizationOverviewPage({
  ...
  const period = resolveReportingPeriod(availableYears, requestedYear);

  return <OrganizationOverviewReport availableYears={availableYears} initialYear={period.year} />;
}
